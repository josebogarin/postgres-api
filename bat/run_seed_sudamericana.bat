...
powershell -NoProfile -Command "Get-Content -Raw -Encoding UTF8 '%~dp0..\documentacion\migraciones\seed_copa_sudamericana.sql' | docker exec -i core-postgres psql -U app_user -d becbuc"
echo.
