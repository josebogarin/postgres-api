...
$result = $query | docker exec -i core-postgres psql -U app_user -d becbuc
$result | Out-File "C:\proyecto FAST API\resultado_tarjetas.txt" -Encoding utf8
$result
Write-Host "`nGuardado en resultado_tarjetas.txt"
pause
